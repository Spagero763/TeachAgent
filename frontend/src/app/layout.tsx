...
export const metadata: Metadata = {
  ...
  other: "talentapp:project_verification":
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <head>
      <meta name="talentapp:project_verification" content="26d93c6c2924a340c78332b6fe2f0b8a063152ed0b4531ac8958758eef58d5f6b928c8275924f0f20b86d0f48751c84023ae34f37c8784122c95f2a7372fde78">
      </head>
